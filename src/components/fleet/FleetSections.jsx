  ...
  return (
    <div>
      <div className="zk-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px,1fr))', marginBottom: 16 }}>
        <StatCard label="Toplam bakım maliyeti" value={fmtTL(total)} tone={COLORS.red} icon={Wrench} />
        <StatCard label="Bakım sayısı" value={vehicleRecords.length} icon={Hash} />
      </div>
...
export function FuelSection({ vehicleId, records, setRecords, settings }) {
  ...
  return (
    <div>
      <div className="zk-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px,1fr))', marginBottom: 16 }}>
        <StatCard label="Toplam yakıt maliyeti" value={fmtTL(totalCost)} tone={COLORS.red} icon={Fuel} />
        <StatCard label="Toplam litre" value={totalLiters.toFixed(1) + ' L'} icon={Fuel} />
...
export function InsuranceDamageSection({ vehicleId, insurance, setInsurance, damages, setDamages }) {
  ...
  return (
    <div>
      ...
      <div className="zk-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px,1fr))', marginBottom: 16 }}>
        <StatCard label="Toplam hasar maliyeti" value={fmtTL(totalDamageCost)} tone={COLORS.red} icon={AlertTriangle} />
        <StatCard label="Hasar sayısı" value={vehicleDamages.length} icon={AlertTriangle} />
      </div>
...
export function FinesSection({ vehicleId, records, setRecords }) {
  ...
  return (
    <div>
      <div className="zk-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(150px,1fr))', marginBottom: 16 }}>
        <StatCard label="Toplam ceza" value={fmtTL(totalAmount)} tone={COLORS.red} icon={ShieldAlert} />
        <StatCard label="Ödenmemiş" value={fmtTL(unpaidAmount)} tone={unpaidAmount > 0 ? COLORS.red : COLORS.olive} icon={ShieldAlert} />
      </div>
      <div className="zk-card" style={{ marginBottom: 16 }}>
