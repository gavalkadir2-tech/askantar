...
import { SearchableSelect } from '../common/index';
...
export function ManualPurchaseTab({ farmers, setFarmers, purchases, setPurchases, priceList, personnel, vehicles, settings, onPrintReceipt }) {
  ...
  return (
    <div>
      ...
      {showAddFarmer && <AddCariModal lockType="tedarikci" farmers={farmers} onClose={() => setShowAddFarmer(false)} onSave={saveNewFarmer} />}
    </div>
  );
}
